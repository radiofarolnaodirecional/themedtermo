...
word_dict = {
    ...
    'theme_aviação' : ['razão', 'vigor', 'pouso', 'nível', 'barra', 'pátio', 'balão', 'radar', 'vetor', 'curva', 'rádio', 'notam', 'metar', 'speci', 'final', 'decea', 'norte', 'leste', 'oeste', 'pista', 'rotas', 'carta', 'dorso'],
